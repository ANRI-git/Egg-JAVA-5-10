...
public class Ejemplo01NoVerificadas {
    ...
    // CASO A - No hago un carajo
//    public static void main(String[] args) {
//        int numero1 = 10, numero2 = 8; //Modificar numero2 a cero y ver lo que pasa
//         int resultado = numero1/numero2;       
//         System.out.println("La division es: "+ resultado);//
//    }
    //CASO B - Preveo lo que puede pasar
//    public static void main(String[] args) {
//        double numero1 = 10, numero2 = 8; //Modificar numero2 a cero y ver lo que pasa
//        try {
